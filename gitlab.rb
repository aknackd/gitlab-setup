...
external_url 'https://git.mycompany.com'
...
gitlab_rails['backup_path'] = "/path/to/gitlab/backups"
...
git_data_dir "/path/to/gitlab/git-data"
...
gitlab_rails['uploads_directory'] = "/path/to/gitlab/uploads"
